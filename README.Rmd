...
LRTesteR provides 42 hypothesis tests and confidence likelihood based on the likelihood ratio statistic. There are 36 tests about distributions and 6 nonparametric tests. All tests have a one sample and an ANOVA style test.

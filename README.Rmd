...
To get a confidence interval, set the conf.level to the desired confidence. The alternative argument controls left, right or two sided intervals. Below gets a 90% confidence interval for scale from a Cauchy random variable. The true value is contained in the interval.

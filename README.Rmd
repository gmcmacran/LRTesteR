...
As implemented, all functions depend on the $\chi^2$ approximation. To get a sense of accuracy of this approximation, the likelihood tests are compared to the exact tests. 

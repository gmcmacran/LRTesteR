...
test_that("x input checking works", {
  expect_error(exponential_rate_one_sample(c()), "Argument x should have at least 50 data points.")
  expect_error(exponential_rate_one_sample(rep("foo", 50)), "Argument x should be numeric.")
})
...
###############################################
test_that("x input checking works", {
  expect_error(exponential_rate_one_way(c()), "Argument x should have at least 50 data points.")
  expect_error(exponential_rate_one_way(rep("foo", 50)), "Argument x should be numeric.")
})
...
test_that("fctr input checking works", {
  ...
  expect_error(exponential_rate_one_way(x, fctr2), "Each groups needs to contain at least 50 points for CIs to be accurate.")
})
rm(fctr1, fctr2)

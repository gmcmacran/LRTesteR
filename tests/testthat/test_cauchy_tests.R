...
test_that("fctr input checking works", {
  ...
  expect_error(cauchy_location_one_way(x, fctr3), "Each groups needs to contain at least 15 data points for CIs to be accurate.")
})
...
test_that("fctr input checking works", {
  ...
  expect_error(cauchy_scale_one_way(x, fctr3), "Each groups needs to contain at least 35 data points for CIs to be accurate.")
})
rm(fctr1, fctr2, fctr3)

...
f <- LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_normal_mu, mu)
...
test_that("calc_test_stat input checking works", {
  expect_error(LRTesteR:::create_test_function_one(1), "Argument calc_test_stat must be a function.")
  expect_error(LRTesteR:::create_test_function_one(calc_test_helper_one, mu), "calc_test_stat's first argument is not x.")
  expect_error(LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_normal_mu, sigma.squared), "calc_test_stat's second argument is does not match p0.")
  expect_error(LRTesteR:::create_test_function_one(calc_test_helper_two, mu), "calc_test_stat's third argument is not alternative.")
  expect_error(LRTesteR:::create_test_function_one(calc_test_helper_three, mu), "calc_test_stat has too many arguments.")
})
rm(calc_test_helper_one, calc_test_helper_two, calc_test_helper_three)

test_that("LB input checking works", {
  expect_error(LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_normal_sigma.squared, sigma.squared, "asdf"), "LB should be numeric.")
  expect_error(LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_normal_sigma.squared, sigma.squared, c(1, 2)), "LB should have length one.")
})
...
f <- LRTesteR:::create_test_function_two(calc_MLE, calc_test_stat, x, n)
test_that("Check structure.", {
  expect_true(class(f) == "function")
...
test_that("calc_test_stat input checking works", {
  expect_error(LRTesteR:::create_test_function_two(1), "Argument calc_MLE must be a function.")
  expect_error(LRTesteR:::create_test_function_two(helper_one), "calc_MLE's first argument is not arg1.")
  expect_error(LRTesteR:::create_test_function_two(helper_two), "calc_MLE's second argument is not arg2.")
  expect_error(LRTesteR:::create_test_function_two(helper_three), "calc_MLE has too many arguments.")
})
...
test_that("calc_test_stat input checking works", {
  expect_error(LRTesteR:::create_test_function_two(calc_MLE, 1), "Argument calc_test_stat must be a function.")
  expect_error(LRTesteR:::create_test_function_two(calc_MLE, helper_one), "calc_test_stat's first argument is not arg1.")
  expect_error(LRTesteR:::create_test_function_two(calc_MLE, helper_two), "calc_test_stat's second argument is not arg2.")
  expect_error(LRTesteR:::create_test_function_two(calc_MLE, helper_three), "calc_test_stat's third argument is not p.")
  expect_error(LRTesteR:::create_test_function_two(calc_MLE, helper_four), "calc_test_stat's fourth argument is not alternative.")
  expect_error(LRTesteR:::create_test_function_two(calc_MLE, helper_five), "calc_test_stat has too many arguments.")
})

...
test_that("calc_test_stat input checking works", {
  ...
  expect_error(LRTesteR:::create_test_function_continuous(calc_test_helper_three, mu), "calc_test_stat has too many arguments.")
})
...
test_that("calc_test_stat input checking works", {
  ...
  expect_error(LRTesteR:::create_test_function_discrete(helper_three), "calc_MLE has too many arguments.")
})
...
test_that("calc_test_stat input checking works", {
  ...
  expect_error(LRTesteR:::create_test_function_discrete(calc_MLE, helper_five), "calc_test_stat has too many arguments.")
})

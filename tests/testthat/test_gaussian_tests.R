...
test_that("fctr input checking works", {
  ...
  expect_error(gaussian_mu_one_way_test(x, fctr3), "Each groups needs to contain at least 15 data points for CIs to be accurate.")
})
...
test_that("fctr input checking works", {
  ...
  expect_error(gaussian_variance_one_way_test(x, fctr3), "Each groups needs to contain at least 45 data points for CIs to be accurate.")
})
rm(fctr1, fctr2, fctr3)

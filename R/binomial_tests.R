...
#' @keywords internal
calc_test_stat_binomial_p <- function(arg1, arg2, prob, alternative) {
  obs_prob <- calc_MLE_binomial_p(arg1, arg2)
...
#' @export
binomial_p_test <- LRTesteR:::create_test_function_one_sample_case_two(LRTesteR:::calc_MLE_binomial_p, LRTesteR:::calc_test_stat_binomial_p, x, size)

#' @keywords internal
calc_test_stat_p_one_way <- function(x, size, fctr) {
  # Null
...
#' binomial_p_one_way_test(x, size, fctr, .95)
#'
#' # Null is false
#' set.seed(1)

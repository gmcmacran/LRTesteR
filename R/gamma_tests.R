...
#' @export
gamma_shape_one_sample <- LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_gamma_shape, shape, 0)
...
#' @export
gamma_scale_one_sample <- LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_gamma_scale, scale, 0)
...
#' @export
gamma_rate_one_sample <- LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_gamma_rate, rate, 0)

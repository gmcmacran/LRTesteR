...
#' @export
beta_shape1_one_sample <- LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_beta_shape1, shape1, 0)
...
#' @export
beta_shape2_one_sample <- LRTesteR:::create_test_function_one(LRTesteR:::calc_test_stat_beta_shape2, shape2, 0)

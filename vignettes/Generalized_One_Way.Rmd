...
As an introduction, lets start with one way ANOVA. Here 3 random variables following a normal distribution with common standard deviation are created. For this test, the null hypothesis is 
...
Here 2 cauchy random variables following a cauchy distribution with common location and different scales are created. For this test, the null hypothesis is 

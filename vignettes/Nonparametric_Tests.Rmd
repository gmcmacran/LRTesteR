...
The following demonstrates the empirical likelihood approach produces similar p values and similar confidence internals in optimal conditions for the parametric method, when sample size is reasonably large.
